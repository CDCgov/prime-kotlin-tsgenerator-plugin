...
enum class CompareFile(val filename: String, val importMode: TypescriptImportMode, val enumType: TypescriptEnumType) {
    ...
    EXPORT_OBJECT_AND_STRING_UNION(
        "api-codegen-export-objectstringunion.ts",
        TypescriptImportMode.EXPORT,
        TypescriptEnumType.OBJECT_AND_STRING_UNION
    ),
    GLOBAL_OBJECT_AND_STRING_UNION(
        "api-codegen-global-objectstringunion.ts",
        TypescriptImportMode.DECLARE_GLOBAL,
        TypescriptEnumType.OBJECT_AND_STRING_UNION
    )
    ;
